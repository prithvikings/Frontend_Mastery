...
<div className='flex items-center gap-4'>
          <button 
          onClick={()=>{
            btnReact === "Sign In" ? setBtnReact("Sign Out") : setBtnReact("Sign In");
          }}
          className='bg-orange-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-orange-600 hover:cursor-pointer'>{btnReact}</button>
